...
TrayIcon_GetInfo(sExeName := "") {
    ...
    for sTray in ["Shell_TrayWnd", "NotifyIconOverflowWindow"] {
        ...
        res := SendMessage(TB_BUTTONCOUNT, 0, 0, "ToolbarWindow32" idxTB, "ahk_class " sTray)
        Loop res {
            TB_GETBUTTON := 0x0417
            SendMessage(TB_GETBUTTON, A_Index - 1, pRB, "ToolbarWindow32" idxTB, "ahk_class " sTray)
